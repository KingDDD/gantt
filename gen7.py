...
# Define tasks with assigned personnel
tasks = [
...
# Create the Gantt chart with text labels
fig = px.timeline(
    df,
    x_start="Start",
    x_end="Finish",
    ...
    text="Assigned To",  # this puts names on bars
    title="Construction Project Gantt Chart (with Task Owners)"
)

fig.update_yaxes(autorange="reversed")

# Improve appearance for dark theme
