...
dark_colors = {
    "Design": "#2c3e50",         # dark blue-gray
    "Subcontracting": "#34495e", # slightly lighter dark blue-gray
    "Implementation": "#1a252f"  # very dark gray-blue
}

# Create Gantt chart with dark colors
fig = px.timeline(
    df,
    x_start="Start",
    x_end="Finish",
    ...
    title="Construction Project Gantt Chart (Dark Colors)",
)
...
fig.update_layout(
    ...
    height=500,
    plot_bgcolor="#f9f9f9"  # optional: light background for contrast
)
